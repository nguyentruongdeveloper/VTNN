...
{
    public class CDM_Don_Vi_Tinh_DAO
    {
        private static CDM_Don_Vi_Tinh_DAO Instance { get; set; }
        public static CDM_Don_Vi_Tinh_DAO getInstance()
        {
            if (Instance == null)
                Instance = new CDM_Don_Vi_Tinh_DAO();
            return Instance;
        }
        private void MapDM_Don_Vi_Tinh(DataRow p_row, CDM_Don_Vi_Tinh p_objDes)
        {
            ...
            if (p_dt.Columns.Contains("Ma_Don_Vi_Tinh"))
                p_objDes.Ma_Don_Vi_Tinh = CUtility.Convert_To_String(p_row["Ma_Don_Vi_Tinh"]);
        ...
        public IList<CDM_Don_Vi_Tinh> List_DM_Don_Vi_Tinh()
        {
            ...
            try
            {
                CSqlHelper.FillDataTable(CConfig.g_strVTNN_Conn_String, v_dt, "sp_sel_List_DM_Don_Vi_Tinh");
        ...
        public CDM_Don_Vi_Tinh Get_DM_Don_Vi_Tinh_By_ID(Int64 p_iID)
        {
            ...
            try
            {
                CSqlHelper.FillDataTable(CConfig.g_strVTNN_Conn_String, v_dt, "sp_sel_Get_DM_Don_Vi_Tinh_By_ID", p_iID);
        ...
        public int Insert_DM_Don_Vi_Tinh(CDM_Don_Vi_Tinh p_objData)
        {
            ...
            try
            {
                v_iRes = Convert.ToInt32(CSqlHelper.ExecuteScalar(CConfig.g_strVTNN_Conn_String, "sp_ins_DM_Don_Vi_Tinh",
        ...
        public void Delete_DM_Don_Vi_Tinh(Int64 p_iAuto_ID, string p_strLast_Updated_By)
        {
            try
            {
                CSqlHelper.ExecuteNonquery(CConfig.g_strVTNN_Conn_String, "sp_del_DM_Don_Vi_Tinh", p_iAuto_ID, p_strLast_Updated_By);
            }
