...
{
    public class CDM_Kho_DAO
    {
        private static CDM_Kho_DAO Instance { get; set; }
        public static CDM_Kho_DAO getInstance()
        {
            if (Instance == null)
                Instance = new CDM_Kho_DAO();
            return Instance;
        }
        private void MapDM_Kho(DataRow p_row, CDM_Kho p_objDes)
        {
            ...
            if (p_dt.Columns.Contains("Ma_Kho"))
                p_objDes.Ma_Kho = CUtility.Convert_To_String(p_row["Ma_Kho"]);
            ...
            if (p_dt.Columns.Contains("Nguoi_Lien_He"))
                p_objDes.Nguoi_Lien_He = CUtility.Convert_To_String(p_row["Nguoi_Lien_He"]);
        ...
        public IList<CDM_Kho> List_DM_Kho()
        {
            ...
            try
            {
                CSqlHelper.FillDataTable(CConfig.g_strVTNN_Conn_String, v_dt, "sp_sel_List_DM_Kho");
        ...
        public CDM_Kho Get_DM_Kho_By_ID(Int64 p_iID)
        {
            ...
            try
            {
                CSqlHelper.FillDataTable(CConfig.g_strVTNN_Conn_String, v_dt, "sp_sel_Get_DM_Kho_By_ID", p_iID);
        ...
        public void Delete_DM_Kho(Int64 p_iAuto_ID, string p_strLast_Updated_By)
        {
            try
            {
                CSqlHelper.ExecuteNonquery(CConfig.g_strVTNN_Conn_String, "sp_del_DM_Kho", p_iAuto_ID, p_strLast_Updated_By);
            }
