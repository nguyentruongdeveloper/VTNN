...
{
    public class CDM_Dieu_Khoan_Thanh_Toan_DAO
    {
        private static CDM_Dieu_Khoan_Thanh_Toan_DAO Instance { get; set; }
        public static CDM_Dieu_Khoan_Thanh_Toan_DAO getInstance()
        {
            if (Instance == null)
                Instance = new CDM_Dieu_Khoan_Thanh_Toan_DAO();
            return Instance;
        }
        private void MapDM_Dieu_Khoan_Thanh_Toan(DataRow p_row, CDM_Dieu_Khoan_Thanh_Toan p_objDes)
        {
            ...
            if (p_dt.Columns.Contains("Ma_Dieu_Khoan"))
                p_objDes.Ma_Dieu_Khoan = CUtility.Convert_To_String(p_row["Ma_Dieu_Khoan"]);

            if (p_dt.Columns.Contains("Ten_Dieu_Khoan"))
                p_objDes.Ten_Dieu_Khoan = CUtility.Convert_To_String(p_row["Ten_Dieu_Khoan"]);
        ...
        public CDM_Dieu_Khoan_Thanh_Toan Get_DM_Dieu_Khoan_Thanh_Toan_By_ID(long p_iID)
        {
            CDM_Dieu_Khoan_Thanh_Toan v_objRes = null;
            DataTable v_dt = new DataTable();

            try
            {
                CSqlHelper.FillDataTable(CConfig.g_strVTNN_Conn_String, v_dt, "sp_sel_Get_DM_Dieu_Khoan_Thanh_Toan_By_ID", p_iID);

                if (v_dt.Rows.Count > 0)
                {
                    v_objRes = new CDM_Dieu_Khoan_Thanh_Toan();
                    MapDM_Dieu_Khoan_Thanh_Toan(v_dt.Rows[0], v_objRes);
                }
            }
