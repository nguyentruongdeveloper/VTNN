...
namespace Utility
{
    public class CExcel_Controller
    {
        ...
        private myExcel.Worksheet m_objWorlSheet = null;
        ...
        public void Create_File()
        {
            ...
            m_objWorkbook = m_objApp.Workbooks.Add(misValue);
        }
        ...
        {
            //myExcel.Worksheet v_objSheet = (myExcel.Worksheet)m_objWorkbook.Sheets[p_iSheet_Index];
            myExcel.Worksheet v_objSheet=(Microsoft.Office.Interop.Excel.Worksheet)m_objWorkbook.Worksheets.get_Item(1);
            //v_objSheet.Cells[1, 1] = "ID";
            myExcel.Range v_Current_Range = v_objSheet.get_Range("A1", "A1");
